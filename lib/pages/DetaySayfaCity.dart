...
class DetaySayfaCity extends StatefulWidget {
  Cities city;

  DetaySayfaCity({this.city});

  @override
  _DetaySayfaCityState createState() => _DetaySayfaCityState();
}
...
class _DetaySayfaCityState extends State<DetaySayfaCity> {
  ...
  Future<List<Companies>> filmleriGoster(int wrap_id) async {
    var url = "https://focaburada.com/api/tum_ilceler_by_id.php";
                ...
                children:[
                  ...
                  SingleChildScrollView(
                    ...
                    child: FutureBuilder<List<Companies>>(
                      future:  aramaYapiliyorMu ? aramaYap(aramaKelimesi): filmleriGoster(int.parse(widget.city.wrap_id)),
